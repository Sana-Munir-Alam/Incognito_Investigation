...
const LandingPage = ({ onFinish }) => {
  ...
  useEffect(() => {
    ...
    // After 5 seconds, trigger callback
  ...
  return (
    <div className="landing-container">
      ...
      <div className="loading-overlay">
        <div className="title glitch-text" data-text="INCOGNITO">
          INCOGNITO
        </div>
        <div className="sub-title">INVESTIGATION</div>
        <p className="tagline">INITIATING MULTIVERSAL PURSUIT...</p>
